...
public enum NodeType {
    ...
    /**
     * 系统提示（由原来的「音乐节点」更名而来）：屏幕角上的提示条，例如右上角显示“存档中…”。
     * <p>自带一套默认样式（深色圆角底 + 淡蓝描边 + 投影 + 白字），不需要美工素材；
     * 显隐与位置都用现有属性控制（{@code visible} / {@code x} / {@code y} / {@code style} /
     * {@code transition}），没有额外的专用属性。</p>
     */
